...
/* Small shared building blocks for the operator flow. */

export function GoogleButton({ onClick }: { onClick?: () => void }) {
  return (
    <button type="button" className="op-btn op-btn--secondary" onClick={onClick}>
      <GoogleG />
...
export function GoogleG() {
  return (
    <svg width="17" height="17" viewBox="0 0 48 48" aria-hidden="true">
      ...
      <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4.1 5.6l6.2 5.2C41.2 35.9 44 30.5 44 24c0-1.3-.1-2.3-.4-3.5z" />
    </svg>
  );
}
