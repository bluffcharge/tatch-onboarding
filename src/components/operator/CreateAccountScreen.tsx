...
/* Step 1 — "Create login": just the credentials. Google sits ABOVE the email
   fields (design call 2026-06-09: don't make people read a whole form before
   discovering the one-click path). Profile details move to step 2. */
export function CreateAccountScreen() {
  ...
  return (
    <OperatorShell step={1} backHref="/operator/signin">
      ...
      <GoogleButton onClick={() => router.push("/operator/account/about?via=google")} />
