...
export function ValuePropCardStack() {
  ...
  return (
    <section aria-roledescription="carousel" aria-label="What you're signing up for" className="w-full">
      ...
      {/* Headline + body for the active card, below the stack. Top margin
          clears the fan's back card (which overhangs ~24px below the aspect
          box) on mobile/tablet without over-spacing. */}
      <div className="mx-auto mt-10 max-w-[360px] text-center md:max-w-[440px]">
