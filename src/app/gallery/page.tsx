...
const ALL_ROUTES: Route[] = [
  ...
  // P2+ — the partner wizard, mirroring the operator signup's structure and
  // design system (Urbanist roadmap brand, rail + floating card).
  { href: "/partner/account",            title: "P2 — Create login",      subtitle: "Email or Google — step 1 of 6",           group: "onboarding", intent: "mobile"  },
  { href: "/partner/account/verify",     title: "P2b — Verify email",     subtitle: "6-digit code · email path only",          group: "onboarding", intent: "mobile"  },
  { href: "/partner/signin",             title: "P2c — Sign in",          subtitle: "Returning partner — minimal",             group: "onboarding", intent: "mobile"  },
  { href: "/partner/account/about",      title: "P3 — About you",         subtitle: "Name + mobile for the app link",          group: "onboarding", intent: "mobile"  },
  { href: "/partner/account/business",   title: "P3b — Your business",    subtitle: "Company name, phone, address",            group: "onboarding", intent: "mobile"  },
  { href: "/partner/account/business?co=northwind", title: "P3c — Join company", subtitle: "Linked-company invite (skips create)", group: "onboarding", intent: "mobile" },
  { href: "/partner/questions",          title: "P4 — Your team",         subtitle: "Technicians + services",                  group: "onboarding", intent: "mobile"  },
  { href: "/partner/team",               title: "P5 — Invite team",       subtitle: "Optional — text a download link",         group: "onboarding", intent: "mobile"  },
  { href: "/partner/activating",         title: "P6 — Activating",        subtitle: "2s connect transition",                   group: "onboarding", intent: "mobile"  },
  { href: "/partner/done",               title: "P7 — Connected",         subtitle: "New-partner success",                     group: "onboarding", intent: "mobile"  },
  { href: "/partner/done?existing=1",    title: "P7 — Short-circuit",     subtitle: "Existing-partner copy",                   group: "onboarding", intent: "mobile"  },
