...
const ALL_ROUTES: Route[] = [
  ...
  { href: "/onboarding/business",            title: "P3 — Your details (full)", subtitle: "Step 2 — full form in card",             group: "onboarding", intent: "mobile", animations: ["brand-ribbons"] },
  { href: "/onboarding/business?v=tight",    title: "P3 — Your details (tight)", subtitle: "Step 2 — confirm + phone/address only",  group: "onboarding", intent: "mobile", animations: ["brand-ribbons"] },
